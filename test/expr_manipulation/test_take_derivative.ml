...
let test_derivative_of_constant () =
  let derivative = D.make (Variable.of_string_exn "x") in
...
let test_derivative_of_sum () =
  let derivative = D.make (Variable.of_string_exn "t") in
...
let test_derivative_respects_variable () =
  let derivative_x = D.make (Variable.of_string_exn "x") in
  let derivative_y = D.make (Variable.of_string_exn "y") in
